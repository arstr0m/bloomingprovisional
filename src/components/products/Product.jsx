    ...
    <>
      ...
      >
        <img 
          ...
          className="h-64 w-full mx-auto object-fit transition duration-500 group-hover:scale-105 sm:h-72"
        />

        <div className="relative border border-gray-100 bg-white p-6 text-xl h-[450px]">
          ...
          <div className="mt-4">
            <a
              ...
              className="absolute bottom-4 mx-2  block w-[1/2] text-white rounded-md bg-[#854782] p-4 font-medium transition hover:scale-105"
            >
              Contactar asistente
            </a>
          </div>

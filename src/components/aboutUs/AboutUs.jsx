  ...
  return (
    <>
      <section className="overflow-hidden pt-20 pb-12 lg:pt-[120px] lg:pb-[90px] ">
        ...
        data-aos-anchor-placement="center-bottom">
                <div className="w-full px-3 sm:px-4 xl:w-1/2">
                  <div className="py-3 sm:py-4">
                    <img
                      src="/assets/abouts/about_2.webp"
                  ...
                  <div className="py-3 sm:py-4">
                    <img
                      src="/assets/abouts/about_1.webp"
                ...
                <div className="w-full px-3 sm:px-4 xl:w-1/2">
                  <div className=" my-4">
                    <img
                      src="/assets/abouts/about_3.webp"
        ...
        data-aos-duration="1300"
        data-aos-anchor-placement="center-bottom">
                <span className="block mb-4 text-center sm:mx-auto md:text-center md:mx-auto text-4xl font-bold text-[#854782] ">
                  Porque nosotros
                </span>
                <h2 className="md:mx-auto text-center sm:mx-auto md:text-center mb-5 text-3xl uppercase font-bold text-[#854782] ">
                 Te queremos ver <img src="/assets/imgs/florecer/FLORECER.png" className="mx-auto w-[300px] "/>
                </h2>
             
                <p className="mb-8 mx-2 h-3/2 text-md text-center">
